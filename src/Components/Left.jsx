        ...
        <div>
          ...
          <ul className='[&>*]:text-slate-500'>
            <li className='flex items-center justify-between h-10 p-2 hover:rounded-md hover:bg-blue-500 hover:text-white'>
              ...
              <svg style={{display: props.open ? "block" : "none"}} xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevron-down" width="1rem" height="1rem" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><polyline points="6 9 12 15 18 9"></polyline></svg>
            </li>
            <li className='flex items-center justify-between h-10 p-2 hover:rounded-md hover:bg-blue-500 hover:text-white'>
              <div className='flex items-center'>
